...
print(f'б: {round(0.1 * 0.2 * 0.75 + 0.9 * 0.2 * 0.25 + 0.1 * 0.8 * 0.25, 4)}')
print(f'в: {round(0.1 * 0.8 * 0.75 + 0.9 * 0.2 * 0.75 + 0.9 * 0.8 * 0.25, 4)}')
print(f'г: {round(1 - 0.9 * 0.8 * 0.75 - 0.1 * 0.2 * 0.25, 4)}')
